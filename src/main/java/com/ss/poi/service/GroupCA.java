...
import com.ss.poi.util.LineChartUtil;
...
public class GroupCA {
	...
	public static void genFunc100040(XWPFParagraph doc, TestResultData data) {
		...
		POITableUtil.setCellValueString(table, 1, 1, data.getTestInputData().get("luoLiuYaoCeVoltMin").getAsString()
				+ "~" + data.getTestInputData().get("luoLiuYaoCeVoltMax").getAsString());
		POITableUtil.setCellValueString(table, 1, 2, data.getTestInputData().get("yanYaYaoCeVoltMin").getAsString()
				+ "~" + data.getTestInputData().get("yanYaYaoCeVoltMax").getAsString());
		POITableUtil.setCellValueString(table, 1, 3, data.getTestInputData().get("kaiGuanJiYaoCeVoltMin").getAsString()
				+ "~" + data.getTestInputData().get("kaiGuanJiYaoCeVoltMax").getAsString());
		POITableUtil.setCellValueString(table, 1, 4,
				data.getTestInputData().get("ziDongChongQiYaoCeVoltMin").getAsString() + "~"
						+ data.getTestInputData().get("ziDongChongQiYaoCeVoltMax").getAsString());
		POITableUtil.setCellValueString(table, 1, 5, data.getTestInputData().get("muXianYaoCeVoltMin").getAsString()
				+ "~" + data.getTestInputData().get("muXianYaoCeVoltMin").getAsString());
	...
	public static void genFunc100050(XWPFParagraph doc, TestResultData data) {
		...
		POITableUtil.setCellValueString(table, 1, 1, data.getTestInputData().get("BoostBuckMin").getAsString() + "~"
				+ data.getTestInputData().get("BoostBuckMax").getAsString());
	...
	public static void genFunc100070(XWPFParagraph doc, TestResultData data) {
		...
		POITableUtil.setCellValueString(table, 1, 0, "指标要求值（V）");
		POITableUtil.setCellValueString(table, 1, 1, data.getTestInputData().get("deltHMin").getAsString() + "~"
				+ data.getTestInputData().get("deltHMax").getAsString());
	...
	public static void genFunc100290(XWPFParagraph doc, TestResultData data) {
		...
		POITableUtil.setCellValueString(table, 1, 0, data.getTestInputData().get("MaxCaption").getAsString());
	...
	public static void genFunc100530(XWPFParagraph doc, TestResultData data) throws Exception {
		...
		//
		POITableUtil.setCellValueString(table, 1, 0, "指标要求值（A）");
		POITableUtil.setCellValueString(table, 1, 1, data.getTestInputData().get("fCurrMin").getAsString() + "~"
	...
	public static void genFunc100570(XWPFParagraph doc, TestResultData data) throws Exception {
		...
		POITableUtil.setCellValueString(table, 1, 0, "上升时间");
		POITableUtil.setCellValueString(table, 2, 0, "上升最大幅值");
		POITableUtil.setCellValueString(table, 3, 0, "上升稳定幅值");
	...
	public static void genFunc100710(XWPFParagraph doc, TestResultData data) {
		...
		POITableUtil.setCellValueString(table, 1, 1, data.getTestInputData().get("dengsiMinTime").getAsString() + "~"
				+ data.getTestInputData().get("dengsiMaxTime").getAsString());
	...
	public static void genFunc500010(XWPFParagraph doc, TestResultData data) throws Exception {
		...
		POITableUtil.setCellValueString(table, 0, 3, "调试结果");
	...
	public static void genFunc102020(XWPFParagraph doc, TestResultData data) throws Exception {
		if (doc == null) {
			return;
		}
		...
		POITableUtil.setCellValueString(table, 1, 2, data.getTestInputData().get("fzCurrMin").getAsString() + "~"
				+ data.getTestInputData().get("fzCurrMax").getAsString());
	...
	public static void genFunc100210(XWPFParagraph doc, TestResultData data) {
		...
		case 100200:
			...
			POITableUtil.setCellValueString(table, 1, 1, data.getTestInputData().get("ovpdyqyMin").getAsString() + "~"
					+ data.getTestInputData().get("ovpdyqyMax").getAsString());
		...
		case 100210:
			...
			POITableUtil.setCellValueString(table, 1, 1, data.getTestInputData().get("ovpdygyMin").getAsString() + "~"
					+ data.getTestInputData().get("ovpdygyMax").getAsString());
			POITableUtil.setCellValueDouble(table, 1, 2, data.getTestExportData().get("ovp").getAsDouble());
			POITableUtil.setCellValueString(table, 1, 3, data.getTestExportData().get("resultCaption").getAsString());
		}
